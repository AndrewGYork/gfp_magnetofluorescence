...
ax.set_title('mScarlet + FMN - 16 mW/cm$^2$ 560 nm excitation')
ax.set_xlim(0,500)
...
##
x1,x2,y1,y2 = 75,250,5340,5370
axins.set_xlim(x1,x2)
axins.set_ylim(y1,y2)
ip = InsetPosition(axins, [0.19, 0.12, 0.78, 0.75])#left edge, bottom edge, width, height
axins.set_axes_locator(ip)
##
mark_inset(ax,axins,loc1=2,loc2=4)#1,3
plt.savefig('/Users/ingaramo/Desktop/magnetofluorescence-main/images/Scarlet_protein/red_power/Figure_scarlet_FMN_10RedPower.png')
plt.show()
