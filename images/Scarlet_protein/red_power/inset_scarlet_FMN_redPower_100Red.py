...
ax.set_title('mScarlet + FMN - 117 mW/cm$^2$ 560 nm excitation')
ax.set_xlim(0,500)
ax.set_ylim(5000,41000)
...
##
x1,x2,y1,y2 = 75,250,33500,35000
...
plt.savefig('/Users/ingaramo/Desktop/magnetofluorescence-main/images/Scarlet_protein/red_power/Figure_scarlet_FMN_100RedPower.png')
plt.show()
